$(function() {
  ...
  $(window).on('scroll', function () {
    var $fvHight =  $(".fv").innerHeight() - 50;
    var $fvImgHight =  $(".fv__img").innerHeight() - 50;
    var $aboutfvHight =  $(".about-fv__img").innerHeight() - 50;
    var $aboutfvImgHight =  $(".about-fv__img-black").innerHeight() - 50;
    var $contactfvHight =  $(".contact-fv__img").innerHeight() - 50;
    var $contactfvImgHight =  $(".contact-fv__img-black").innerHeight() - 50;
  
   if (  $fvHight < $(this).scrollTop() || $aboutfvImgHight < $(this).scrollTop() || $contactfvImgHight < $(this).scrollTop() ) { 
   $('.header__menu').addClass('change-color'); 
   $('.drawer-icon__bar1').addClass('change-color');
   $('.drawer-icon__bar2').addClass('change-color');
   $('.drawer-icon__bar3').addClass('change-color');
   }
   else {
   $('.header__menu').removeClass('change-color'); 
   $('.drawer-icon__bar1').removeClass('change-color');
   $('.drawer-icon__bar2').removeClass('change-color');
   $('.drawer-icon__bar3').removeClass('change-color');
  } 


   if (  $fvImgHight < $(this).scrollTop() || $aboutfvHight < $(this).scrollTop() || $contactfvHight < $(this).scrollTop() ) { 
   $('.header__title a').addClass('change-color'); 
   }
   else {
   $('.header__title a').removeClass('change-color'); 
  } 
});  
